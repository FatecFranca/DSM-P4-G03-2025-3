...
**Repositório do GRUPO 03 do Projeto Interdisciplinar do 4º semestre DSM 2025/1**
...
```bash
git clone https://github.com/seu-usuario/DSM-P4-G03-2025-3.git
cd DSM-P4-G03-2025-3
```
...
- Professores e orientadores do curso DSM
- Comunidade open source pelas bibliotecas utilizadas
- Colegas de turma pelo feedback e sugestões

---

**Desenvolvido com ❤️ pelo Grupo 03 - DSM 2025/1**
